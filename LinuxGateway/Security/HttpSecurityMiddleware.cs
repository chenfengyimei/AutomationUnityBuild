...
{
    public static void UseLinuxGatewaySecurity(this WebApplication app)
    {
        LinuxGatewayOptions options = app.Services.GetRequiredService<LinuxGatewayOptions>();
    ...
    private static bool HasCrossSiteOrigin(HttpRequest request, LinuxGatewayOptions options)
    {
    ...
    private static bool IsConfiguredAllowedOrigin(Uri originUri, LinuxGatewayOptions options)
    {
