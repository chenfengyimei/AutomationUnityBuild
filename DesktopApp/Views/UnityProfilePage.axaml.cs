...
public partial class UnityProfilePage : UserControl
{
    public UnityProfilePage() { InitializeComponent(); DataContext = new UnityProfilePageViewModel(); }
    private UnityProfilePageViewModel VM => (UnityProfilePageViewModel)DataContext!;
